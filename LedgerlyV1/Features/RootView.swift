...
struct RecoveryView: View {
    ...
    private var title: L10n.Key {
        recovery == .integrity ? .recoveryIntegrityTitle : recovery == .unsupportedFormat ? .recoveryUnsupportedTitle : .recoveryRetryableTitle
    }

    private var detail: L10n.Key {
        recovery == .integrity ? .recoveryIntegrityDetail : recovery == .unsupportedFormat ? .recoveryUnsupportedDetail : .recoveryRetryableDetail
    }
}
